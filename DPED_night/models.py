...
def resnet(input_image, num_images):

    with tf.compat.v1.variable_scope("generator"):

        W1 = weight_variable([9, 9, int(4*num_images), 64], name="W1")
        ...
        c12 = _conv_tranpose_layer(c11, 64, 3, 2)  # 128 -> 256

        # Final

        W12 = weight_variable([9, 9, 64, 3], name="W12")
        b12 = bias_variable([3], name="b12")
        enhanced = tf.nn.tanh(conv2d(c12, W12) + b12) * 0.58 + 0.5
