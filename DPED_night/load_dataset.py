...
def load_val_data(dataset_dir, dslr_dir, phone_dir, PATCH_WIDTH, PATCH_HEIGHT, input_images=1, val_dir="val/", test_images=-1):

    val_directory_dslr = dataset_dir + val_dir + dslr_dir
    val_directory_phone = [dataset_dir + val_dir + phone_dir + '/']
    if input_images == 3:
        val_directory_phone.append(dataset_dir + val_dir + phone_dir + '_over/')
        val_directory_phone.append(dataset_dir + val_dir + phone_dir + '_under/')
...
def load_train_patch(dataset_dir, dslr_dir, phone_dir, TRAIN_SIZE, PATCH_WIDTH, PATCH_HEIGHT, input_images=1):
    ...
    train_answ = np.zeros((TRAIN_SIZE, int(PATCH_WIDTH * 2), int(PATCH_HEIGHT * 2), 3))
